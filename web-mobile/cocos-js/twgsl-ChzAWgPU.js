    ...
    return {
        execute: (function () {
            ...
            var Module = function Module(_Module) {
              _Module = _Module || {};
              var _Module = typeof _Module != "undefined" ? _Module : {};
              var moduleOverrides = Object.assign({}, _Module);
              ...
              function locateFile(path) {
                if (_Module["locateFile"]) {
                  return _Module["locateFile"](path, scriptDirectory);
                }
              ...
              var out = _Module["print"] || console.log.bind(console);
              var err = _Module["printErr"] || console.warn.bind(console);
              Object.assign(_Module, moduleOverrides);
              moduleOverrides = null;
              if (_Module["arguments"]) _Module["arguments"];
              if (_Module["thisProgram"]) thisProgram = _Module["thisProgram"];
              if (_Module["quit"]) quit_ = _Module["quit"];
              var wasmBinary;
              if (_Module["wasmBinary"]) wasmBinary = _Module["wasmBinary"];
              var noExitRuntime = _Module["noExitRuntime"] || true;
              ...
              function updateGlobalBufferAndViews(buf) {
                buffer = buf;
                _Module["HEAP8"] = HEAP8 = new Int8Array(buf);
                _Module["HEAP16"] = new Int16Array(buf);
                _Module["HEAP32"] = HEAP32 = new Int32Array(buf);
                _Module["HEAPU8"] = HEAPU8 = new Uint8Array(buf);
                _Module["HEAPU16"] = new Uint16Array(buf);
                _Module["HEAPU32"] = HEAPU32 = new Uint32Array(buf);
                _Module["HEAPF32"] = new Float32Array(buf);
                _Module["HEAPF64"] = new Float64Array(buf);
              }
              _Module["INITIAL_MEMORY"] || 16777216;
              var __ATPRERUN__ = [];
              var __ATINIT__ = [];
              var __ATPOSTRUN__ = [];
              ...
              function initRuntime() {
                if (!_Module["noFSInit"] && !FS.init.initialized) FS.init();
              ...
              function createWasm() {
                ...
                function receiveInstance(instance, module) {
                  ...
                  _Module["asm"] = exports;
                  wasmMemory = _Module["asm"]["o"];
                  updateGlobalBufferAndViews(wasmMemory.buffer);
                  _Module["asm"]["s"];
                  addOnInit(_Module["asm"]["p"]);
                  removeRunDependency();
                }
                addRunDependency();
                ...
                if (_Module["instantiateWasm"]) {
                  try {
                    var exports = _Module["instantiateWasm"](info, receiveInstance);
                    return exports;
                  } catch (e) {
              ...
              var FS = {
                ...
                open: function open(path, flags, mode) {
                  ...
                  if (_Module["logReadFiles"] && !(flags & 1)) {
                ...
                createStandardStreams: function createStandardStreams() {
                  if (_Module["stdin"]) {
                    FS.createDevice("/dev", "stdin", _Module["stdin"]);
                  } else {
                    FS.symlink("/dev/tty", "/dev/stdin");
                  }
                  if (_Module["stdout"]) {
                    FS.createDevice("/dev", "stdout", null, _Module["stdout"]);
                  } else {
                    FS.symlink("/dev/tty", "/dev/stdout");
                  }
                  if (_Module["stderr"]) {
                    FS.createDevice("/dev", "stderr", null, _Module["stderr"]);
                  } else {
                ...
                init: function init(input, output, error) {
                  ...
                  FS.ensureErrnoError();
                  _Module["stdin"] = input || _Module["stdin"];
                  _Module["stdout"] = output || _Module["stdout"];
                  _Module["stderr"] = error || _Module["stderr"];
              ...
              function _proc_exit(code) {
                if (!keepRuntimeAlive()) {
                  if (_Module["onExit"]) _Module["onExit"](code);
                  ABORT = true;
                }
              ...
              function _return_string(data, length) {
                _Module._return_string_callback(data, length);
              }
              ...
              createWasm();
              _Module["___wasm_call_ctors"] = function () {
                return (_Module["___wasm_call_ctors"] = _Module["asm"]["p"]).apply(null, arguments);
              };
              _Module["_test"] = function () {
                return (_Module["_test"] = _Module["asm"]["q"]).apply(null, arguments);
              };
              _Module["_spirv_to_wgsl"] = function () {
                return (_Module["_spirv_to_wgsl"] = _Module["asm"]["r"]).apply(null, arguments);
              };
              var _malloc = _Module["_malloc"] = function () {
                return (_malloc = _Module["_malloc"] = _Module["asm"]["t"]).apply(null, arguments);
              };
              _Module["_free"] = function () {
                return (_Module["_free"] = _Module["asm"]["u"]).apply(null, arguments);
              };
              var ___cxa_is_pointer_type = _Module["___cxa_is_pointer_type"] = function () {
                return (___cxa_is_pointer_type = _Module["___cxa_is_pointer_type"] = _Module["asm"]["v"]).apply(null, arguments);
              };
              var calledRun;
              ...
              return new Promise(function (resolve) {
                Module({
                  ...
                  onRuntimeInitialized: function onRuntimeInitialized() {
                    ...
                    var convertSpirV2WGSL = function convertSpirV2WGSL(code) {
                      if (!twgsl._return_string_callback) {
                        twgsl._return_string_callback = function (data, length) {
                          var bytes = new Uint8ClampedArray(twgsl.HEAPU8.subarray(data, data + length));
                          wgsl = textDecoder.decode(bytes);
                        };
                      }
                      var addr = twgsl._malloc(code.byteLength);
            ...
            var instance;
            var twgsl = exports("default", (function (options) {
              if (!instance) {
